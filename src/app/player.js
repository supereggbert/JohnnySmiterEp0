...
var attack = {
      ...
      rowLen: 5513,   // In sample lengths
      patternLen: 30,  // Rows per pattern
      endPattern: 0,  // End pattern
      numChannels: 1  // Number of channels
    };
...
var sound=function(song,volume,loop){
    var cplayer=new CPlayer;
    cplayer.init(song);
    cplayer.generate();
    var blob = new Blob([cplayer.createWave()], {type: 'audio/wav'}); // pass a useful mime type here
...
var Rune=sound(rune,0.3);
var Boom=sound(boom,1);
var Shoot=sound(shoot,.2);
var Attack=sound(attack,1);
var Wind=sound(wind,0.5,true);
var Start=sound(start,1);
var End=sound(end,1);
export {Rune, Boom, Attack, Shoot, Wind, Start, End}
